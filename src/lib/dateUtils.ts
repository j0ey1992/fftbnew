 ...
 */
export function formatDate(date: Date | string | undefined | { toDate?: () => Date }): string {
  if (!date) return 'N/A';
 ...
 */
export function isExpired(date: Date | string | undefined | { toDate?: () => Date }): boolean {
 ...
 */
export function formatRelativeTime(date: Date | string | undefined | { toDate?: () => Date }): string {
  if (!date) return 'N/A';
